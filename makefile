...
makefile.conf: CoqProject
	C:\Coq\bin\coq_makefile.exe -f CoqProject -o makefile
...
VDFILE_FLAGS:=$(if CoqProject,-f CoqProject,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)

$(VDFILE): CoqProject $(VFILES)
	$(SHOW)'COQDEP VFILES'
